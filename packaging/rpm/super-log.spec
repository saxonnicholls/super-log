...
%build
cd /src
# Fresh build dir every time. This runs bind-mounted at /src, so a build-rpm/
...
%changelog
* Mon Sep 07 2026 Saxon Herschel Nicholls <me@saxonnicholls.com> - 0.4.0-1
- super-log 0.4.0: FIX session logs and MAVLink drone telemetry, plus the
